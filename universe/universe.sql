...
CREATE TABLE public.meteor (
    ...
    name character varying(255) NOT NULL,
    meteor_types character varying(125) NOT NULL,
...
--
-- Name: meteor_star_id_seq; Type: SEQUENCE; Schema: public; Owner: freecodecamp
--

CREATE SEQUENCE public.meteor_star_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.meteor_star_id_seq OWNER TO freecodecamp;

--
-- Name: meteor_star_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: freecodecamp
--

ALTER SEQUENCE public.meteor_star_id_seq OWNED BY public.meteor.star_id;
...
CREATE TABLE public.star (
    ...
    planet_types character varying(125) NOT NULL,
    galaxy_id integer NOT NULL
);
...
--
-- Name: meteor star_id; Type: DEFAULT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.meteor ALTER COLUMN star_id SET DEFAULT nextval('public.meteor_star_id_seq'::regclass);
...
--
-- Name: meteor_star_id_seq; Type: SEQUENCE SET; Schema: public; Owner: freecodecamp
--

SELECT pg_catalog.setval('public.meteor_star_id_seq', 1, false);
